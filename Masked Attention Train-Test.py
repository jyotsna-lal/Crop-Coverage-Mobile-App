okay dont go on doing things yet i am just senidg you my earlier ml dl prjects codem, its v long so one by one, analyse it 

training plus testing masked attention transofrmer 
import os
import numpy as np
